...
final class Plugin {
	...
	/**
	 * Enqueues Table Reorder styles and PoC scripts in the editor content document.
	 */
	public static function enqueue_table_reorder_content_assets(): void {
		...
		self::enqueue_sortablejs_poc_content_script();
	}

	/**
	 * Enqueues the SortableJS PoC inside the editor content document.
	 */
	private static function enqueue_sortablejs_poc_content_script(): void {
